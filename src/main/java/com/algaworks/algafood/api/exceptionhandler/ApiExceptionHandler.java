...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
	...
	private ResponseEntity<Object>handleMethodArgumentTypeMismatch(
		...
		String detail = String.format("O parâmetro de URL %s, recebeu o valor '%s',"+" que é de um tipo inválido. Corriga e informe um valor compatível com o tipo '%s.'", 
	...
	public ResponseEntity<Object> handleUncaught(Exception ex, WebRequest request){
		...
		String detail = "Ocorreru um erro interno inesperado no sistema."
